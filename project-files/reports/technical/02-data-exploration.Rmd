...
-------        ----------  --------------------------------------
timestamp      text        The date and time of the event being logged in "%Y-%m-%dT%H:%M:%OS3Z" format (see R spec)
               (/datetime) 
...
eventName      text        The event type being logged, can be:
                           ...
                           - **Uploading** - Uploading finished wortk

eventType      text        Either START or STOP for whether the relevant task is starting or stopping
...
Column         Data type   Description
-------        ----------  --------------------------------------
timestamp      text        The timestamp for when the GPU was polled for its metrics.
               (/datetime) 

hostname       text        VM hostname, matches with `application-checkpoints` dataset
