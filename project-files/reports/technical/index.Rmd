...
The orignal project was undertaken in a module intended to teach about data project methodology (in that case CRISP-DM) and sticks very strictly to the prescribed format for the writeup, both this report and the summary version are written in a more flexible format, omitting headings where unneeded, and are overall just much less verbose (though if you do want the nitty gritty, the original is also included in this repo).
